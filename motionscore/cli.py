...
def _build_parser() -> argparse.ArgumentParser:
    ...
    model_download.add_argument("--model-id", default="", help="Model id from the catalog (defaults to catalog default)")
    model_download.add_argument("--model-root", type=Path, default=None)
